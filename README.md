...
[프로젝트 개요](#-프로젝트-개요) • [핵심 기능](#-핵심-기능) • [시스템 구조](#-시스템-아키텍처) • [문제 해결](#-담당-및-문제-해결) • [구현 경계](#-현재-구현-경계)
...
**이정운 — 비전 AI·음성 에이전트 및 Embedded HW 통합 트러블슈팅**

- 현장 배경을 반영한 보호구 인식 흐름 개선
- ESP32-S3 데이터시트·핀맵 기반 카메라/오디오 핀 충돌 분석
- 오디오 신호선 재배선과 전원·접지·커패시터 개선
- HW·AI·서버·관제 시스템 연동 점검
