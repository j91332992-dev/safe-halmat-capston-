...
#define CAMERA_TARGET_FPS 8
#define CAMERA_INTERVAL_MS (1000 / CAMERA_TARGET_FPS)
// Preserve low-latency STT/TTS and calls by yielding camera bandwidth.
#define CAMERA_VOICE_INTERVAL_MS 1000
#define CAMERA_CALL_INTERVAL_MS 1000
